...
def Main():
    ...
    LocalManager.LensManager.ChangeParameter('LambdaIn',6.33e-07)
    ...
    Ranges     = [['','',1],[-1e-5,1e-5,100],[6.370324e-7,6.75776e-7,400]]
    ...
    BasePath   = 'D:/Dropbox/Dropbox/Data/G - Reports/2017 - Projects/2017_06_19 - Depth Absorption Simulations/Simulated Spectra/BiVO4/Data 633nm/NewData'
    Processors = 8
    WhoMulti   = 1
    Fold       = 1
    #--PROCESS PARAMETERS--
