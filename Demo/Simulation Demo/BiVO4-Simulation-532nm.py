        ...
        if self.ParametersDict['IndexProfileLoaded']:
            ...
            if (OutWavelength < self.AbsVal[0]) or (OutWavelength < self.AbsVal[-1]):
                ...
                if OutWavelength < self.AbsVal[Index]:
                    ...
                    return (    (self.AbsVal[Index] - self.AbsVal[Index-1])
                    ...
                    return (    (self.AbsVal[Index+1] - self.AbsVal[Index])
            ...
            return self.ParametersDict['Absorption']
...
class SampleCube:
    ...
    def CorrectAbsPosition(self):
        ...
        for i in range(1,len(ToConsider)):
            ...
            if ToConsider[i][1] == 0:
                ...
                #append the distance
                Z += ToConsider[i][0].ParametersDict['Depth']* ToConsider[i][0].ProcessCurrentIndex(self.Parent.Parent.LensManager.ParametersDict['LambdaOut']) /ToConsider[i-1][0].ProcessCurrentIndex(self.Parent.Parent.LensManager.ParametersDict['LambdaOut'])
    ...
    def AddEffectiveIntensityFact(self,Mask):
        ...
        self.CollectedIntensity = self.Intensity* Mask[0]
            ...
            for i in range(0,len(ToConsider)):
                ...
                if ToConsider[len(ToConsider)-1-i][1] == 1:
                    ...
                    if ToConsider[len(ToConsider)-1-i][0].ParametersDict['Abs']:
                        ...
                        #absorb
                        Absorption += Cube.Parent.ParametersDict['Absorption'] * Dist
                ...
                if ToConsider[len(ToConsider)-1-i][1] == 0:
                    ...
                    if ToConsider[len(ToConsider)-1-i][0].ParametersDict['Abs']:
                        ...
                        #absorb
                        Absorption += ToConsider[len(ToConsider)-1-i][0].ParametersDict['Absorption'] * Dist
...
#        Parameters['XSteps'] = 01    #defines the amount of cubes in X
#        Parameters['YSteps'] = 01    #defines the amount of cubes in Y
#        Parameters['XDim']   = 2.e-6 #defines the dimension of the cube
#        Parameters['YDim']   = 2.e-6 #defines the dimension of the cube
#        
#        self.SampleManager.ChangeParameter(2, 'Raman',True)
#        self.SampleManager.ChangeParameter(2, 'Illuminated',True)
#        self.SampleManager.ChangeParameter(2, 'Depth',float(0.1e-6))
#        self.SampleManager.ChangeParameter(2, 'Absorption',10000.0)
#        self.SampleManager.ChangeParameter(2, 'Abs',True)
#        self.SampleManager.ChangeParameter(2, 'Index',3.)
#        self.SampleManager.ChangeParameter(2, 'Integration',True)
#        self.SampleManager.CreateCubes(2, Parameters)
#
#        Parameters = {}
#
#        Parameters['ZSteps'] = 1000   #defines the amount of cubes in Z
...
#        Parameters['YDim']   = 2.e-6 #defines the dimension of the cube
#
#        self.SampleManager.ChangeParameter(3, 'Raman',True)
#        self.SampleManager.ChangeParameter(3, 'Illuminated',True)
#        self.SampleManager.ChangeParameter(3, 'Depth',float(100e-6))
#        self.SampleManager.ChangeParameter(3, 'Absorption',10000.0)
#        self.SampleManager.ChangeParameter(3, 'Abs',True)
#        self.SampleManager.ChangeParameter(3, 'Index',4.)
#        self.SampleManager.ChangeParameter(3, 'Integration',True)
#        self.SampleManager.CreateCubes(3, Parameters)
#
#
#        Parameters = {}
#        
...
#        Parameters['YDim']   = 2.e-6 #defines the dimension of the cube
#        
#        self.SampleManager.ChangeParameter(4, 'Raman',True)
#        self.SampleManager.ChangeParameter(4, 'Illuminated',True)
#        self.SampleManager.ChangeParameter(4, 'Depth',float(30e-6))
#        self.SampleManager.ChangeParameter(4, 'Absorption',10000.0)
#        self.SampleManager.ChangeParameter(4, 'Abs',True)
#        self.SampleManager.ChangeParameter(4, 'Index',1.0)
#        self.SampleManager.ChangeParameter(4, 'Integration',True)
#        self.SampleManager.CreateCubes(4, Parameters)

        #run the laser illumniation
#        self.RunIllumination()
...
#    """
#    ###########################################################################
#    This routine will launch the processing if called by the terminal...
#    
#    
#    ###########################################################################
#    """
#
#    Manager = Manager()
#    Manager.DefaultRunIllumination()
#    Manager.CreatePlotableIllumination()
#    Manager.SampleManager.ChangeParameter(1,'RamanProfilePath','Raman_File_1.txt')
#    Manager.SampleManager.SampleLinks[1].LoadRamanResponseProfile()
#    
#    print Manager.LensManager.LensElements[0]
#    print Manager.LensManager.LensElements[1]
#    print Manager.LensManager.LensElements[2]
#    print Manager.SampleManager
#    
#    #Manager.LensManager.LensElements[2].ChangeParameter('Parameters',1.0)
#    
#    Start = -1.e-5
#    End   = 1.e-5
#    Steps = 100
...
#    VariableSteps_1 = 5
#    
#    VariableRange_2 = [100000.0,1009000.0]
#    VariableSteps_2 = 10
#    
#    for k in range(0, VariableSteps_2):
#        
#        Variable_2 = (VariableRange_2[0]+
#                          (VariableRange_2[1] - VariableRange_2[0])
#                          / float(VariableSteps_2)* float(k))
#        
#        Manager.SampleManager.ChangeParameter(1,'Absorption',Variable_2)
#        
#        for j in range(0,VariableSteps_1):
#            
#            Variable_1 = (VariableRange_1[0]+
#                          (VariableRange_1[1] - VariableRange_1[0])
#                          / float(VariableSteps_1)* float(j))
#            
#            #Manager.LensManager.LensElements[2].ChangeParameter('Parameters', Variable_1)
#            
#            Manager.SampleManager.ChangeParameter(1,'Index',Variable_1)
#            Array = numpy.zeros((Steps,2))
#            
#            for i in range(Steps):
#        
#                Array[i][0] = (End - Start)/float(Steps) * float(i) + Start
#                
#                Manager.LensManager.ChangeParameter('FocalPosition',(End - Start)/float(Steps) * float(i) + Start)
#                Manager.RunIllumination()
#                Manager.SampleManager.CorrectCubes()
#                Manager.SampleManager.ResetCollectionIntensities()
#                Manager.SampleManager.CollectedIntensity()
#
#                Array[i][1] = Manager.SampleManager.Intensity[1]
#                #Array[i][2] = Manager.SampleManager.Intensity[2]
#                #Array[i][3] = Manager.SampleManager.Intensity[3]
#                #Array[i][4] = Manager.SampleManager.Intensity[4]
#                
#                print (End - Start)/Steps * float(i) + Start
#                print Manager.SampleManager.Intensity
#
#            numpy.savetxt( 'OUTPUT_'+str(11)+'_'+str(len(Manager.SampleManager.SampleLinks))+'_Index_'+str(Variable_1)+'_Abs_'+str(Variable_2)+'_Thickness_'+str(Manager.SampleManager.SampleLinks[1].ParametersDict['Depth'])+'.txt ', Array)
#
#
#
...
def Main():
    ...
    LocalManager.LensManager.ChangeParameter('LambdaIn',5.32e-07)
    ...
    Ranges     = [['','',1],[-1e-5,1e-5,100],[534.845e-9,561.892e-9,400]]
    ...
    BasePath   = 'D:/Dropbox/Dropbox/Data/G - Reports/2017 - Projects/2017_06_19 - Depth Absorption Simulations/Simulated Spectra/BiVO4/Data 532nm/NewData'
    Processors = 8
    WhoMulti   = 1
    Fold       = 1
    #--PROCESS PARAMETERS--
